...
export default function ExplorePage() {
  return (
    <div className="min-h-screen bg-blue-100 text-gray-900  px-1">
      <div className="h-44 bg-blue-400 flex items-center justify-center mb-8 ">
      ...
      <div className=" grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {classes.map((item, idx) => (
          <div
            key={idx}
            className=" rounded-lg shadow-md overflow-hidden hover:shadow-xl transition"
          >
            <Image
              src={item.image}
              alt={item.title}
